...
//LEFT JOIN actividad on beca.actividad_id = actividad.actividad_id
	...
	function save($params){
		...
		$sqli = "insert into beca (tipo_beca_id,alumno_id,md5,cargo_id,fuero_id,dependencia_id
			...
			,costo,monto,dictamen_por,sup_horaria,tipo_actividad_id,actividad_nombre,domicilio_constituido,renovacion_id) 
			...
			,'$params[tipo_actividad_id]','$params[actividad_nombre]','$domicilio','$params[renovacion_id]')";
			//echo $sqli;
			//execute query
			$res = $db->exec_query($sqli);
